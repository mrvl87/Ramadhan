    ...
    return (
        <div className="space-y-6 animate-in fade-in slide-in-from-right-4 duration-500">
            ...
            <div className="space-y-3">
                <label className="text-sm font-bold text-emerald-950 block">Rasio Foto</label>
            ...
            <div className="space-y-3">
                <div className="flex items-center justify-between">
                    <label className="text-sm font-bold text-emerald-950 block">Ucapan & Teks (Opsional)</label>
                    <button
                ...
                <div className="space-y-2">
                    <input
                        ...
                        className="w-full text-sm p-3 rounded-lg border border-slate-200 focus:ring-2 focus:ring-emerald-500 outline-none"
                    />
                    <textarea
                        ...
                        rows={3}
                        className="w-full text-sm p-3 rounded-lg border border-slate-200 focus:ring-2 focus:ring-emerald-500 outline-none resize-none"
                    />
                </div>
            </div>
            ...
            <div className="pt-4">
                <Button
                    ...
                    className="w-full h-12 text-lg bg-emerald-600 hover:bg-emerald-700 text-white shadow-lg shadow-emerald-200"
                >
