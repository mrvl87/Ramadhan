                                ...
                                <div className="relative w-full h-full min-h-[500px]">
                                    ...
                                    <div className="absolute inset-0 bg-black/40 opacity-0 group-hover:opacity-100 transition-all flex items-end justify-center p-6">
                                        <a
                                            ...
                                            className="flex items-center justify-center gap-2 w-full bg-white text-emerald-900 py-3 rounded-xl font-bold hover:bg-emerald-50 shadow-lg transform translate-y-4 group-hover:translate-y-0 transition-transform"
                                        >
